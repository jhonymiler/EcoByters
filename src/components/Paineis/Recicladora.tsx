...
export default function Recicladora() {
    ...
    useEffect(() => {
        ...
        addTokenToWallet();
    }, [balance, tokenAddress, symbol, decimals, icon]);
            ...
            <Card>
                <Card.Body>
                    ...
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Button className="mt-3" variant="primary" type="submit" disabled={isPending || isConfirming}>
                            {isPending ? 'Enviando...' : isConfirming ? 'Confirmando...' : 'Registrar'}
                        </Button>
                        {isConfirmed && <div className="mt-3 text-success">Transação confirmada!</div>}
                    </Form>
                </Card.Body>
            </Card>
        </>
